...
public class FinalBossScript : MonoBehaviour {
   ...
   public void TakeDamage(float damage)
   {
	...
	IEnumerator HitChangeColor(){
		Renderer rendBoss = gameObject.GetComponentInChildren<Renderer>();
		rendBoss.material.color = new Color(2.4f, 0.9f, 0.9f, 0.5f);
		yield return new WaitForSeconds(0.5f); 
		rendBoss.material.color = new Color(1f, 1f, 1f, 1f);
